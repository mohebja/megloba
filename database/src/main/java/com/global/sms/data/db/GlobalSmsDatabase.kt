...
abstract class GlobalSmsDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_30_31 = object : Migration(30, 31) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Row id of the matching entry in content://sms, once this app writes to the system
                // provider as the default SMS app (see SystemSmsProvider). Null for messages that predate
                // this version, and for any row written while a different app was the default.
